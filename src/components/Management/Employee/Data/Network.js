...
const Network = () => {
    ...
    const loadUsers = async() => {
        const result = await axios.get("http://localhost:2020/network");
        setUser(result.data);
    };
                    ...
                    <tbody>
                        {
                            filteredList.map((user,index) => (
                                <tr>
                                    ...
                                    <td>{user.Name}</td>
                                    <td>{user.Experience.AWS}</td>
                                    <td>{user.Experience.WebApp}</td>
                                    <td>{user.Experience.Portals}</td>
                                    <td>{user.Results.AWS}</td>
                                    <td>{user.Results.WebApp}</td>
                                    <td>{user.Results.Portals}</td>
                                    <td>{user.Salary}</td>
